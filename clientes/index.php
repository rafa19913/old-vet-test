...
<section id="content">
    ...
    <table>
		...
		if(isset($_POST['buscar'])){
			$aux = $_POST['buscar'];
		$query = $query . ' where id_cliente like "' . $aux . '" or nombre like "%'.$aux.'%"' . ' or email like "%'.$aux.'%"' . ' or telefono like "%'.$aux.'%"' . ' or celular like "%'.$aux.'%"' ;
		}
		//echo $query;
    ...
    echo '<tr>
      ...
      <td><a href="mascotas.php?id='.$cliente['id_cliente'].'">Ver Mas</a></td>
        </tr>';
        }
